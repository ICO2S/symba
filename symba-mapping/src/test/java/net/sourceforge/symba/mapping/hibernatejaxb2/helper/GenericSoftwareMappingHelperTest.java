...
public class GenericSoftwareMappingHelperTest {
    ...
    public void testSoftware2EquipmentLink() {
        ...
        genericSoftware.setEndurant( DatabaseObjectHelper.getOrLoadEndurant( null, null ) );
        ...
        // add an Endurant value (required) after saving the endurant to the database
        genericEquipment.setEndurant( DatabaseObjectHelper.getOrLoadEndurant( null, null ) );
