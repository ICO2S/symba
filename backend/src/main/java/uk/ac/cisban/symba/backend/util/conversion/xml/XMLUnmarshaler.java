...
import uk.ac.cisban.symba.backend.util.conversion.helper.CisbanFuGEHelper;
 ...
 * $Author: ally $
 * $HeadURL: https://metagenome.ncl.ac.uk/subversion/cisban/DataPortal/trunk/cisbandpi/dpi/src/main/java/uk/ac/cisban/dpi/util/conversion/xml/XMLUnmarshaler.java $
 *
 */
...
public class XMLUnmarshaler {
    ...
    public String Jaxb2ToFuGE() throws JAXBException, SAXException, RealizableEntityServiceException, LSIDException, URISyntaxException, FileNotFoundException {
        ...
        CisbanFuGEHelper cf = new CisbanFuGEHelper( reService );
        fr = cf.unmarshalFuGE( frXML, fr );
