...
public class StoreAndRetrieveTest {
    ...
    public void createIdentifiable() {
        ...
        DatabaseObjectHelper.getOrCreate( "createIdentifiable:Organization:" + String.valueOf( Math.random() ),
                null, "createIdentifiableWithPerformer", "net.sourceforge.fuge.common.audit.Organization" );
    }
    ...
    public void saveIdentifiable() {
        ...
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( "saveIdentifiable:Organization:" + String.valueOf( Math.random() ),
                null, "saveIdentifiableWithPerformer", "net.sourceforge.fuge.common.audit.Organization" );

        // add an Endurant value (required) after saving the endurant to the database
        organization.setEndurant( DatabaseObjectHelper.getOrLoadEndurant( null, null ) );
    ...
    public void saveDescribableWithPerformer() {
        ...
        Person performer = ( Person ) DatabaseObjectHelper.getOrCreate( "saveDescribableWithPerformer:Performer:" + String.valueOf( Math.random() ),
                null, "saveDescribableWithPerformer", "net.sourceforge.fuge.common.audit.Person" );

        // add an Endurant value (required) after saving the endurant to the database
        Endurant endurant = DatabaseObjectHelper.getOrLoadEndurant( null, null );

        performer.setEndurant( endurant );
    ...
    public void saveIdentifiableWithURI() {
        ...
        // Create the Identifiable Object locally
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( "saveIdentifiableWithPerformer:Organization:" + String.valueOf( Math.random() ),
                null, "saveIdentifiableWithPerformer", "net.sourceforge.fuge.common.audit.Organization" );
        ...
        organization.setEndurant( endurant );
    ...
    public void saveIdentifiableWithPerformer() {
        ...
        // Create the performer
        Person performer = ( Person ) DatabaseObjectHelper.getOrCreate( "saveIdentifiableWithPerformer:Performer:" + String.valueOf( Math.random() ),
                null, "saveIdentifiableWithPerformer", "net.sourceforge.fuge.common.audit.Person" );
    ...
    public void getIdentifiableById() {
        ...
        // next test
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( "getIdentifiableById:Organization:" + String.valueOf( Math.random() ),
                null, "getIdentifiableById", "net.sourceforge.fuge.common.audit.Organization" );
    ...
    public void getIdentifiableByIdentifier() {
        ...
        // Create the Identifiable Object locally: we're choosing the identifier explicitly here so we can get it in the
        // next test
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( "getIdentifiableByIdentifier:Organization:" + String.valueOf( Math.random() ),
                null, "getIdentifiableByIdentifier", "net.sourceforge.fuge.common.audit.Organization" );
    ...
    public void saveOrganizationWithNewNVTSet() {
        ...
        // Create the Identifiable Object locally: we're choosing the identifier explicitly here so we can get it in the
        // next test
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( "saveOrganizationWithNewNVTSet:Organization:" + String.valueOf( Math.random() ),
                null, "saveOrganizationWithNewNVTSet", "net.sourceforge.fuge.common.audit.Organization" );
    ...
    public void saveOrganizationWithPreLoadedNVTSet() {
        ...
        // Create the Identifiable Object locally: we're choosing the identifier explicitly here so we can get it in the
        // next test
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( "saveOrganizationWithPreLoadedNVTSet:Organization:" + String.valueOf( Math.random() ),
                null, "saveOrganizationWithPreLoadedNVTSet", "net.sourceforge.fuge.common.audit.Organization" );
