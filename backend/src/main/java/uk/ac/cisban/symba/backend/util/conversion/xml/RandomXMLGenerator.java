 ...
 * $Author: ally $
 * $HeadURL: https://metagenome.ncl.ac.uk/subversion/cisban/DataPortal/trunk/cisbandpi/dpi/src/main/java/uk/ac/cisban/dpi/util/conversion/xml/RandomXMLGenerator.java $
 *
 */
...
public class RandomXMLGenerator {
    ...
    public void generate() throws JAXBException, SAXException, FileNotFoundException {
        ...
        CisbanFuGEHelper cf = new CisbanFuGEHelper( null );
