...
public class CisbanHelper {
    ...
    public static CisbanHelper create( RealizableEntityService reService ) {
        return create( reService, DEFAULT_DEBUG );
    }

    public static CisbanHelper create( RealizableEntityService reService,
                                       boolean debugValue ) {
        return new CisbanHelper( reService, debugValue );
    }

    private final boolean verbose;
    private LsidAssigner assigner;
    ...
    private CisbanHelper( RealizableEntityService reService,
        ...
        // get the assigner
        this.assigner = ( LsidAssigner ) context.getBean( "clientAssigner" );
    ...
    public Identifiable getOrCreateLatest( String endurantId,
                                           ...
                                           String possibleName,
                                           String className ) throws RealizableEntityServiceException {
    ...
    public String getLSID( String className ) {
        // create the new LSID
    ...
    public Identifiable overwriteIdsAndLoad( Identifiable identifiable,
                                             ...
                                             Person person ) throws RealizableEntityServiceException {
