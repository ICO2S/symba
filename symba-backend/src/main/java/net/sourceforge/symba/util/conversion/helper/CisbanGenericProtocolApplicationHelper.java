...
public class CisbanGenericProtocolApplicationHelper implements MappingHelper<GenericProtocolApplication, FugeOMCommonProtocolGenericProtocolApplicationType> {
    ...
    public FugeOMCommonProtocolGenericProtocolApplicationType marshal(
            FugeOMCommonProtocolGenericProtocolApplicationType genericProtocolApplicationXML,
            GenericProtocolApplication genericProtocolApplication ) throws RealizableEntityServiceException {
        ...
        if ( genericProtocolApplication.getGenericOutputMaterials() != null &&
                !genericProtocolApplication.getGenericOutputMaterials().isEmpty() ) {
            System.out.println(
                    "Found Output Materials directly before marshaling " + genericProtocolApplication.getIdentifier() );
        } else {
    ...
    public FugeOMCommonProtocolGenericProtocolApplicationType generateRandomXML( FugeOMCommonProtocolGenericProtocolApplicationType fugeOMCommonProtocolGenericProtocolApplicationType ) {
        return null;
    }
