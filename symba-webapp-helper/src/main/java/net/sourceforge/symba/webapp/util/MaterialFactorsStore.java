...
public class MaterialFactorsStore {
    ...
    private Map<String, LinkedHashSet<String>> multipleCharacteristics;
    ...
    private Map<String, String> novelCharacteristics;
    ...
    private Map<String, LinkedHashSet<String>> novelMultipleCharacteristics;
    ...
    public Map<String, String> getNovelCharacteristics() {
    ...
    public Map<String, LinkedHashSet<String>> getMultipleCharacteristics() {
    ...
    public void addMultipleCharacteristics( String ontologySourceEndurant,
                                            LinkedHashSet<String> ontologyTermEndurants ) {
        this.multipleCharacteristics.put( ontologySourceEndurant, ontologyTermEndurants );
    }

    public Map<String, LinkedHashSet<String>> getNovelMultipleCharacteristics() {
    ...
    public void addNovelMultipleCharacteristics( String ontologySourceEndurant,
                                                 LinkedHashSet<String> ontologyTermEndurants ) {
