...
import net.sourceforge.symba.util.conversion.helper.*;
...
public class WorkflowUnmarshaler {
    ...
    public void Jaxb2ToFuGE( String[] inputFilenames ) throws FileNotFoundException, JAXBException, RealizableEntityServiceException, URISyntaxException {
        ...
        for ( int iii = 1; iii < inputFilenames.length; iii++ ) {
            ...
            if ( fuGEType.getMaterialCollection() != null ) {
                ...
                // get and store all information in the database
                CisbanMaterialCollectionHelper cmc = new CisbanMaterialCollectionHelper();
            ...
            if ( fuGEType.getDataCollection() != null ) {
                ...
                // get and store all information in the database
                CisbanDataCollectionHelper collectionHelper = new CisbanDataCollectionHelper();
