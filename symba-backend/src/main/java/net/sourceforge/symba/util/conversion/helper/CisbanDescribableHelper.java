...
public class CisbanDescribableHelper implements MappingHelper<Describable, FugeOMCommonDescribableType> {
    private final int NUMBER_ELEMENTS = 2;

    public CisbanDescribableHelper() {
    }
    ...
    public Describable unmarshal( FugeOMCommonDescribableType describableXML,
                                  Describable describable ) throws RealizableEntityServiceException {
        ...
        if ( auditTrailXML != null ) {
            ...
            for ( FugeOMCommonAuditAuditType auditXML : auditsXML ) {
                // create fuge object
                Audit audit = null;
                audit = ( Audit ) reService.createDescribableOb( "fugeOM.Common.Audit.Audit" );

                // set fuge object
                audit = ( Audit ) unmarshal( auditXML, audit );
        ...
        if ( descriptionsElementXML != null ) {
            ...
            for ( FugeOMCommonDescriptionDescriptionType descriptionXML : descriptionsXML ) {
                ...
                description = ( Description ) unmarshal( descriptionXML, description );
        ...
        if ( exturiElementXML != null ) {
            ...
            // set fuge object
            exturi = ( Uri ) unmarshal( exturiXML, exturi );
//            exturi.setUri( new java.net.URI( exturiXML.getUri() ) );
        ...
        if ( propertySetsXML != null ) {
            ...
            for ( FugeOMCommonNameValueTypeType nameValueTypeXML : nameValueTypesXML ) {
                ...
                // set fuge object
                nameValueType = ( NameValueType ) unmarshal( nameValueTypeXML, nameValueType );
    ...
    public FugeOMCommonDescribableType marshal( FugeOMCommonDescribableType describableXML,
        ...
        if ( describable.getAuditTrail() != null && !describable.getAuditTrail().isEmpty() ) {
            ...
            for ( Object auditObj : describable.getAuditTrail() ) {
                ...
                // set jaxb object
                auditXML = ( FugeOMCommonAuditAuditType ) marshal( auditXML, audit );
        ...
        if ( !describable.getDescriptions().isEmpty() ) {
            ...
            for ( Object descriptionObj : descriptions ) {
                ...
                // set jaxb object
                descriptionXML = ( FugeOMCommonDescriptionDescriptionType ) marshal(
        ...
        if ( exturi != null ) {
            ...
            // set jaxb object
            exturiXML = ( FugeOMCommonDescriptionExternalURIType ) marshal( exturiXML, exturi );
        ...
        if ( !( nameValueTypes = describable.getPropertySets() ).isEmpty() ) {
            ...
            for ( Object nameValueTypeObj : nameValueTypes ) {
                ...
                // set jaxb object
                nameValueTypeXML = ( FugeOMCommonNameValueTypeType ) marshal(
    ...
    public FugeOMCommonDescribableType generateRandomXML( FugeOMCommonDescribableType type ) {
        ...
        for ( int i = 0; i < NUMBER_ELEMENTS; i++ ) {
            ...
            if ( type instanceof FugeOMCollectionFuGEType )
                auditXML = ( FugeOMCommonAuditAuditType ) generateRandomXML( auditXML );
        ...
        for ( int i = 0; i < NUMBER_ELEMENTS; i++ ) {
            ...
            // set jaxb object
            if ( type instanceof FugeOMCollectionFuGEType )
                descriptionXML = ( FugeOMCommonDescriptionDescriptionType ) generateRandomXML( descriptionXML );
        ...
        // set jaxb object
        if ( type instanceof FugeOMCollectionFuGEType )
            exturiXML = ( FugeOMCommonDescriptionExternalURIType ) generateRandomXML( exturiXML );
        ...
        for ( int i = 0; i < NUMBER_ELEMENTS; i++ ) {
            ...
            // set jaxb object
            if ( type instanceof FugeOMCollectionFuGEType )
                nameValueTypeXML = ( FugeOMCommonNameValueTypeType ) generateRandomXML( nameValueTypeXML );
    ...
    public Describable getLatestVersion( Describable describable ) throws RealizableEntityServiceException {

        // prepare updated set
        Set<Audit> set = new HashSet<Audit>();
        for ( Object obj : describable.getAuditTrail() ) {
            Audit audit = ( Audit ) obj;
            audit = ( Audit ) getLatestVersion( audit );
            ...
            audit.setPerformer( ( Contact ) ( new CisbanIdentifiableHelper() ).getLatestVersion( identifiable ) );
            set.add( audit );
        }
        ...
        for ( Object obj : describable.getDescriptions() ) {
            set2.add( ( Description ) getLatestVersion( ( Describable ) obj ) );
        }
...
//        describable.setAnnotations( set3 );
        ...
        if ( describable.getExturi() != null ) {
            describable.setExturi( ( Uri ) getLatestVersion( describable.getExturi() ) );
        }
        ...
        if ( describable.getSecurity() != null ) {
            ...
            describable.setSecurity( ( Security ) ( new CisbanIdentifiableHelper() ).getLatestVersion( s ) );
        }
        ...
        for ( Object obj : describable.getPropertySets() ) {
            set4.add( ( NameValueType ) getLatestVersion( ( Describable ) obj ) );
        }
