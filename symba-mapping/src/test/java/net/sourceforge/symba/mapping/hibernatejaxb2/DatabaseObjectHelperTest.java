...
public class DatabaseObjectHelperTest {
    ...
    public void getOrCreateTest() {
        ...
        Organization organization = ( Organization ) DatabaseObjectHelper.getOrCreate( null,
                null, "Test Organization for getOrCreate()", "net.sourceforge.fuge.common.audit.Organization" );
        ...
        Organization secondOrganization = ( Organization ) DatabaseObjectHelper.getOrCreate( organization.getIdentifier(),
                null,
                "Nothing should be loaded from the name attribute on a get from the database", "net.sourceforge.fuge.common.audit.Organization" );
